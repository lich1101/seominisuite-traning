(function($) {
    $(document).ready(function(e) {
        ...
        $(".page-search button.btn-submit btn-type-1").click(function(e) {
            console.log(123);
        ...
        var result = $(".result tbody tr").sort(function(a, b) {
            var contentA = parseInt($(a).find("td[data-key='created']").attr("data-value"));
            var contentB = parseInt($(b).find("td[data-key='created']").attr("data-value"));
        ...
        $(".sort").click(function(e) {
            ...
            var result = $(".result tbody tr").sort(function(a, b) {
                switch (sort) {
                    case "title":
                    case "domain":
                        var contentA = removeAccents($(a).find("td[data-key='" + sort + "'] .sort-text").text().trim().replaceAll(" ", "")).toLowerCase();
                        var contentB = removeAccents($(b).find("td[data-key='" + sort + "'] .sort-text").text().trim().replaceAll(" ", "").toLowerCase());
                        break;
                    case "1_3":
                    case "1_5":
                    case "1_10":
