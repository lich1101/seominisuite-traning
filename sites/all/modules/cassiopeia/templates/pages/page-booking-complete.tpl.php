...
if($result->nid==AGENCY){
    $Total = $result->price;
}else{
    $Total = $result->month*$result->price;
}
?>
<div class="page-booking-complete">
    ...
    font-weight: bold;" class="c-green"><?php echo number_format($Total,0,",","."); ?> VNĐ</span></p>
                <p>Nội dung chuyển khoản: <b><?php echo $code; ?></b></p>
                <div>
        ...
        <div class="mt-24 d-flex jsc-end">
            <button type="button" class="btn btn-buy-product-complete lts-1-25 bg-green c-white fs-16">Hoàn tất</button>
        </div>
    </div>
</div>
