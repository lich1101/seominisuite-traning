...
(function ($) {
    Drupal.behaviors.cassiopeia_guest_post_website_search_form = {
        attach: function (context, settings) {
            $('.cassiopeia-guest-post-website-search-form', context).once('cassiopeia-guest-post-website-search-form',function () {
        ...
        detach: function(context, settings, trigger) {
            $('.cassiopeia-guest-post-website-search-form', context).removeOnce('cassiopeia-guest-post-website-search-form', function() {});
        }
    };
})(jQuery);