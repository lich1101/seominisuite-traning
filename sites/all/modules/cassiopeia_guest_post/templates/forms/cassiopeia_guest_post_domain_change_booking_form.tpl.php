<?php
$price = cassiopeia_guest_post_domain_change_booking_price_load($form['price']['#value']);
?>
<div class="page-title mb-24">
    <h1>Mua thêm lượt đổi Domain</h1>
</div>
...
<div class="bg-white pd-24 radius-5 box-shadow payment-info mb-24">
    ...
    <div class="d-flex justify-between price">
        <span>Giá gói</span>
        <span><b><?php echo number_format($price->price,0,",","."); ?>đ</b>/lượt</span>
    </div>
    <div class="d-flex justify-between quantity">
        <span>Số lượt đổi domain</span>
        <span><?php echo $price->quantity; ?>lượt</span>
    </div>
    <div class="d-flex justify-between total-price">
        <label for="">Tổng tiền</label>
        <b class="color-green"><?php echo number_format($price->quantity*$price->price,0,",","."); ?>VND</b>
    </div>
</div>
