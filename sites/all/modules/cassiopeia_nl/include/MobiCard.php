...
class MobiCard {
  ...
  function CardPay($pin_card, $card_serial, $type_card, $_order_code, $client_fullname, $client_mobile, $client_email) {

    $_merchant_id = variable_get('nl_merchant_id');
    $_merchant_pass = variable_get('nl_merchant_pass');

    $params = array(
      'func' => 'CardCharge',
      'version' => '2.0',
      'merchant_id' => variable_get('nl_merchant_id'),
      'merchant_account' => variable_get('nl_email'),
      'merchant_password' => MD5($_merchant_id . '|' . $_merchant_pass),
      'pin_card' => $pin_card,
      'card_serial' => $card_serial,
      'type_card' => $type_card,
      'ref_code' => $_order_code,
    ...
    $api_url = variable_get('nl_card_url', '');
