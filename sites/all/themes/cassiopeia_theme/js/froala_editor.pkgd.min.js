    ...
    V.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), V.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", V.LinkRegExTLD = "((".concat(V.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), V.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(V.LinkRegExCommon, ")"), V.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(V.LinkRegExCommon, ")"), V.LinkRegExWWW = "(www\\.".concat(V.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), V.LinkRegEx = "(".concat(V.LinkRegExTLD, "|").concat(V.LinkRegExHTTP, "|").concat(V.LinkRegExWWW, "|").concat(V.LinkRegExAuth, ")").concat(V.LinkRegExEnd), V.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], V.MAIL_REGEX = /.+@.+\..+/i, V.MODULES.helpers = function(i) {
        ...
        function v(e, t, n) {
            ...
            if (e) {
                ...
                if (e) {
                    ...
                    s.attr(n), s.insertBefore(e), (r = b(e)) && (0 <= ["strong", "em"].indexOf(t) || "span" === t && n.hasOwnProperty("style")) && (i = "span" === t ? (o = (a = n.style.replace(/;$/, "").split(":"))[0].trim(), a[1].trim()) : (o = a[t].prop, a[t].val), "background-color" !== o && (T(r).css(o, i), function C(e, t) {
                    ...
                    if (l) {
                        if (T(l).find(".fr-marker").length || "UL" === l.tagName || "OL" === l.tagName) v(l.firstChild, t, n);
                        else if (M.browser.mozilla && M.node.hasClass(l, "fr-marker")) {
                            var d, f = M.selection.blocks(),
                                p = f.length;
                            for (d = 0; d < p; d++) f[d] != l.parentNode && f[d].childNodes.length && f[d].childNodes[0] != l.parentNode && (l = f[d].childNodes[1] || f[d].childNodes[0], (s = T(g(t, n)).insertBefore(l)).append(l))
                        }
                    } else {
                        for (var h = s.get(0).parentNode; h && !h.nextSibling && !M.node.isElement(h);) h = h.parentNode;
                        if (h) {
                            var u = h.nextSibling;
                            u && (M.node.isBlock(u) ? "HR" === u.tagName ? v(u.nextSibling, t, n) : v(u.firstChild, t, n) : v(u, t, n))
                        }
                    }
                    s.is(":empty") && s.remove()
                }
        ...
        function n(e, t) {
            ...
            if (void 0 === t && (t = {}), t.style && delete t.style, M.selection.isCollapsed()) {
                M.markers.insert(), M.$el.find(".fr-marker").replaceWith(g(e, t) + V.INVISIBLE_SPACE + V.MARKERS + function a(e) {
                    return "</".concat(e, ">")
        ...
        function r(e, t) {
            ...
            for (var r = !0; r;) {
                ...
                for (var o, i = {
                    ...
                    var l = a[s];
                    if (l.innerHTML && 8203 == l.innerHTML.charCodeAt() && l.tagName.toLocaleLowerCase() == n && l.childNodes.length < 2 && (l.outerHTML = l.innerHTML), M.node.hasClass(l, "fr-marker")) t = (t + 1) % 2;
                    else if (t)
            ...
            if (M.selection.isCollapsed()) {
                ...
                if (M.node.openTagString(d.get(0)) === '<span style="'.concat(e, ": ").concat(d.css(e), ';">')) {
                    if (M.node.isEmpty(d.get(0))) c = T(M.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS)), d.replaceWith(c);
                        ...
                        var f = {};
                        f["style*"] = "".concat(e, ":"), x(r, "span", f, !0), r = M.$el.find(".fr-marker"), t ? (c = T(M.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS)), r.replaceWith(c)) : r.replaceWith(V.INVISIBLE_SPACE + V.MARKERS)
                    }
        ...
        function e(e) {
            ...
            r = u.merge(r, O.opts.htmlAllowedEmptyTags), r = void 0 === e ? u.merge(r, V.BLOCK_TAGS) : u.merge(r, V.NO_DELETE_TAGS), t = O.el.querySelectorAll("*:empty:not(".concat(r.join("):not("), "):not(.fr-marker):not(template)"));
            do {
                n = !1;
        ...
        function L() {
            h(), O.placeholder && setTimeout(O.placeholder.refresh, 0)
        }
        return {
            defaultTag: d,
            isPreformatted: s,
            ...
            set: function M(e) {
                ...
                O.edit.on(), O.core.injectStyle(O.opts.iframeDefaultStyle + O.opts.iframeStyle), C(), O.opts.useClasses || (O.$el.find("[fr-original-class]").each(function() {
            ...
            get: function _(e, t) {
                ...
                if (O.node.isEmpty(O.el)) O.opts.fullPage && (n = w(O.iframe_document), n += "<html".concat(O.node.attributes(O.$html.get(0)), ">").concat(O.$html.find("head").get(0).outerHTML, "<body></body></html>"));
                    ...
                    var M = O.opts.heightMin,
                        T = O.opts.height,
                        N = O.opts.heightMax;
                    O.opts.heightMin = null, O.opts.height = null, O.opts.heightMax = null, O.size.refresh(), n += "<html".concat(O.node.attributes(O.$html.get(0)), ">").concat(O.$html.html(), "</html>"), O.opts.heightMin = M, O.opts.height = T, O.opts.heightMax = N, O.size.refresh(), O.$el.addClass("fr-view")
                } else n = O.$el.html();
            ...
            getSelected: function T() {
                function e(e, t) {
                    for (; t && (t.nodeType === Node.TEXT_NODE || !O.node.isBlock(t)) && !O.node.isElement(t) && !O.node.hasClass(t, "fr-inner");) t && t.nodeType !== Node.TEXT_NODE && u(e).wrapInner(O.node.openTagString(t) + O.node.closeTagString(t)), t = t.parentNode;
            ...
            insert: function N(e, t, n) {
                var r;
                if (O.selection.isCollapsed() || O.selection.remove(), r = t ? e : O.clean.html(e), 0 === e.indexOf('<i class="fa ') && (r = "<span>&nbsp;".concat(r, "</span>")), e.indexOf('class="fr-marker"') < 0 && (r = function a(e) {
                        var t = O.doc.createElement("div");
                        return t.innerHTML = e, O.selection.setAtEnd(t, !0), t.innerHTML
                    }(r)), O.node.isEmpty(O.el) && !O.opts.keepFormatOnDelete && f(r)) O.opts.trackChangesEnabled ? O.track_changes.pasteInEmptyEdior(r) : O.el.innerHTML = r;
                else {
                    (function s() {
                        var e = O.selection.ranges(0).commonAncestorContainer;
                        return e !== O.el && !O.$el.contains(e)
                    })() && O.selection.restore();
                    var o = O.markers.insert();
                    if (o)
                        if (O.opts.trackChangesEnabled) O.track_changes.pasteInEdior(r);
                        else {
                            O.node.isLastSibling(o) && u(o).parent().hasClass("fr-deletable") && u(o).insertAfter(u(o).parent());
                            ...
                            if ((f(r) || n) && (O.node.deepestParent(o) || i && "LI" === i.tagName)) {
                                if (i && "LI" === i.tagName && (r = function l(e) {
                                        ...
                                        for (var n = t.querySelectorAll(":scope > ".concat(O.html.defaultTag())), r = n.length - 1; 0 <= r; r--) {
                                            var o = n[r];
                                            O.node.isBlock(o.previousSibling) || (o.previousSibling && !O.node.isEmpty(o) && u("<br>").insertAfter(o.previousSibling), o.outerHTML = o.innerHTML)
                                        }
                                        return t.innerHTML
                ...
                C(), O.keys.positionCaret(), O.events.trigger("html.inserted")
            },
            wrap: t,
            unwrap: function A() {
                O.$el.find("div.fr-temp-div").each(function() {
                    this.previousSibling && this.previousSibling.nodeType === Node.TEXT_NODE && u(this).before("<br>"), u(this).attr("data-empty") || !this.nextSibling || O.node.isBlock(this.nextSibling) && !u(this.nextSibling).hasClass("fr-temp-div") ? u(this).replaceWith(u(this).html()) : u(this).replaceWith("".concat(u(this).html(), "<br>"))
        ...
        function d() {
            A.opts.iframe && A.$el.attr("contenteditable", "true"), A.browser.edge && A.opts.iframe && A.$box.after(i), O || (A.keys.forceUndo(), O = A.snapshot.get()), a || (a = i.get(0).innerHTML, x = i.text(), A.selection.restore(), A.events.enableBlur());
                    ...
                    if (c.buttons) {
                        ...
                        if (i.showMoreButtons && p < f) {
                            ...
                            if (0 < m.length) m.removeClass("fr-hidden fr-open");
                                ...
                                var v = l,
                                    b = V.COMMANDS[v];
                                b.more_btn = !0, m = S(E.button.build(v, b, !0)), E.button.addButtons(m)
                            }
                            h && h.append(m)
                        }
