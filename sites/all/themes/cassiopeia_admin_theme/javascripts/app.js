...
(function ($) {
    $(document).ready(function(){
        $("input[name='gift']").change(function (e) {
            let _id = $(this).attr("data-id");
            let val = $(this).val();
            if(confirm("Bạn chắc chắn muốn cập nhật đơn hàng này?")){
                $.ajax({
                    method   :"POST",
                    url      :"/cassiopeia/ajax",
                    data     : {
        ...
        $(".btn-booking-delete").click(function (e) {
            let code = $(this).attr("data-code");
            if(confirm("Bạn chắc chắn muốn cập nhật trạng thái cho đơn hàng này?")){
                $.ajax({
                    method   :"POST",
                    url      :"/cassiopeia/ajax",
                    data     : {
        ...
        $(".page-booking-manager select[name='status']").change(function (e) {
            var status = $(this).val();
